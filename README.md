...
![Entries](https://img.shields.io/badge/entries-5%2C166-5a31d8)
...
**5,166 entries covering 5,076 distinct CVEs, spanning 2010 to 2026** - organized by the six layers of the stack, top to bottom:
...
| `control-plane` | Cluster management, storage, CI/CD, observability | 917 |
| `kernel-hypervisor` | Host kernel, userspace, virtualization, microcode | 992 |
...
The field that makes this more than an advisory mirror. A CVSS score tells you how bad a vulnerability is; it does not tell you whether fixing it costs a config change or a firmware flash across every node you own. 3,708 entries carry a `fleet.pain_class`, from cheapest to most disruptive:
...
| `node-reboot` | 2,065 | Full reboot of each affected node |
