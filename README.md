...
![Entries](https://img.shields.io/badge/entries-4%2C892-5a31d8)
...
**4,892 entries covering 4,705 distinct CVEs, spanning 2010 to 2026** - organized by the six layers of the stack, top to bottom:
...
| `control-plane` | Cluster management, storage, CI/CD, observability | 823 |
...
| `firmware-bmc-fabric` | BMC/IPMI/Redfish, BIOS/UEFI, NVLink, InfiniBand, DPUs, PDUs, cooling | 1,103 |
...
The field that makes this more than an advisory mirror. A CVSS score tells you how bad a vulnerability is; it does not tell you whether fixing it costs a config change or a firmware flash across every node you own. 3,396 entries carry a `fleet.pain_class`, from cheapest to most disruptive:

| Class | Entries | What it means |
| --- | ---: | --- |
| `hot-patch` | 78 | Fixable without interrupting workloads |
| `daemon-restart` | 474 | Service restart on affected nodes |
